# Meeting: Caldrisa compliance review
...
**Daniel:** Thanks for making time. I would like to focus on GDPR and healthcare data controls and keep the discussion tied to a pilotable workflow.
...
**Elena:** The risk I want recorded is this: Clara requires clear exclusion of patient-level records and a deletion process.
...
**Daniel:** Next action: Daniel will revise the memo and keep operational-support wording.
